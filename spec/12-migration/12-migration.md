...
**Автоматизированная миграция:** `tsclang migrate` *(roadmap — фаза 13)* применяет все механические правки из раздела ниже автоматически. Детали команды — в [09-build.md](../09-build/09-build.md) (раздел «`tsclang migrate`»).
