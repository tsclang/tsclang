...
> **СТАТУС: РЕШЕНО.**
>
> **ПРИОРИТЕТ:** при конфликте с другими разделами spec (05b-ownership.md и др.) по темам spread, destructuring, merge — доминирует этот файл. Решения здесь зафиксированы после аудита impl/spec/tests и являются окончательными.
>
...
## 10. Влияние на 05b-ownership.md

Решение «всегда copy» для spread/destructuring/merge **не отменяет** move semantics в 05b для прямого присваивания. Move остаётся для:
