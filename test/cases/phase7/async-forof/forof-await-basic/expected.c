...
typedef struct { int32_t _state; int32_t _result; bool _done; int32_t x; } processItem_state;

static void processItem_poll(processItem_state *self) {
    switch (self->_state) {
        case 0:
...
case_1:
        case 1:
            ...
            self->_await_0 = (processItem_state){0};
            self->_state = 2;
            /* fall through */
        case 2:
