...
| Метрика | До | После (2026-06-08) |
|---------|-----|-------|
| "Активных" расхождений старого doc | ~42 | **2** (0 STILL PRESENT + 2 NEEDS INVESTIGATION) |
...
### Подтверждённые открытые проблемы (итого 0)
