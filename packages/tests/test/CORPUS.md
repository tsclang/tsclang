...
```
packages/tests/test/cases/<section>/<feature>/<test-name>/
...
## 02-syntax — Базовый парсинг и кодогенерация
...
## 04-ownership / 08-collections — Модель памяти
...
## 12-modules / 13-build — Модульная система
...
## 11-concurrency — Threads и низкоуровневая конкурентность
...
## 14-stdlib — Стандартная библиотека
