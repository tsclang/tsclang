...
int main(void) {
    ...
    if (arr_i32.length == 0) { fprintf(stderr, "panic[E407]: Math.min: empty array\n"); abort(); }
    ...
    printf("%d\n", _min_1);
    if (arr_i32.length == 0) { fprintf(stderr, "panic[E407]: Math.max: empty array\n"); abort(); }
    ...
    if (arr_f64.length == 0) { fprintf(stderr, "panic[E407]: Math.min: empty array\n"); abort(); }
    ...
    if (arr_f64.length == 0) { fprintf(stderr, "panic[E407]: Math.max: empty array\n"); abort(); }
