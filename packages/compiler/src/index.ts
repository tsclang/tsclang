...
export { DIAGNOSTICS, lookupDiagnostic, explainError, substituteParams, resolveDiagnostic } from './compiler/diagnostics.js';
export type { DiagnosticEntry, DiagnosticCode, Severity, ResolvedDiagnostic } from './compiler/diagnostics.js';
