...
static nums_result nums_next(nums_state *self) {
    switch (self->_state) {
        case 0: self->_state = 1; return (nums_result){10, false};
        case 1: self->_state = 2; return (nums_result){20, false};
        case 2: self->_state = 3; return (nums_result){30, false};
        case 3: self->_done = true; return (nums_result){0, true};
    }
