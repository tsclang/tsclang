...
> ~~2026-04-02: написан черновой codegen...~~ (код удалён, начинаем заново)
> ~~2026-04-03: Phase 0: 15/15 ✓~~ (код удалён, начинаем заново)
>
> 2026-04-03: Начинаем реализацию заново. Изучены тесты Phase 0 (15 тестов): console.*, Error, performance.now(). Понятен формат тестов: input.tsc → expected.c + expected.out. Проверена компиляция C через GCC (MSYS2) и MSVC (vcvars64.bat). Временные файлы в temp/.
>
> **Текущее состояние:**
> - src/ — пусто
> - bin/ — пусто
> - runtime.h — не создан
> - Тесты Phase 0 определены в doc/phase0/
>
> 2026-04-03: изучена структура тестов Phase 0 (console.log/error/warn/debug, Error, performance.now). Проверена компиляция C через GCC и MSVC. Обновлён AGENTS.md (задача, ключевые файлы, компиляция C, temp/). Код компилятора был удалён ранее — начинаем реализацию с нуля.
>
> **Следующий шаг:** написать lexer/parser/codegen для Phase 0
