...
- Текущий статус: компилятор реализован (фазы 0–19), все 1254 теста проходят
...
test/cases/           — тестовый корпус (phase0–phase19)
  ...
  phase3/             — Модель памяти (179 тестов)
...
- Все 20 фаз: 1254 теста проходят, 0 пропусков, 0 ошибок
